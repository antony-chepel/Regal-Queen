...
class RealQueenWeb : AppCompatActivity() {
    private val FILECHOOSERRESULTCODE = 1

    // the same for Android 5.0 methods only
    var fsddwqdqwioiqw: ValueCallback<Array<Uri>>? = null
    var poiowudqudwq: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vv.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                fsddwqdqwioiqw?.onReceiveValue(null)
                fsddwqdqwioiqw = filePathCallback
                ...
                if (takePictureIntent!!.resolveActivity(packageManager) != null) {
                    ...
                    try {
                        ...
                        takePictureIntent.putExtra("PhotoPath", poiowudqudwq)
                    ...
                    if (photoFile != null) {
                        poiowudqudwq = "file:" + photoFile.absolutePath
        ...
        vv.loadUrl(bxgxgfspwooqeqes())
    }



    fun bxhchscqweqwewqd(string: String){
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun bxgxgfspwooqeqes(): String {
        ...
        val first = "http://"
        val second = "regalqueen.xyz/go.php?to=2&"
        ...
        bxhchscqweqwewqd(afId.toString())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode != FILECHOOSERRESULTCODE || fsddwqdqwioiqw == null) {
        ...
        if (resultCode == AppCompatActivity.RESULT_OK) {
            if (data == null || data.data == null) {
                ...
                results = arrayOf(Uri.parse(poiowudqudwq))
            } else {
        ...
        fsddwqdqwioiqw?.onReceiveValue(results)
        fsddwqdqwioiqw = null
    }
